class Counter {
    constructor(ctx, canvasWidth, canvasHeight) {
        ...
        this.updateDimensions(canvasWidth, this.scale);

        this.img = new Image();
        this.img.src = "imgs/counter.png";
        this.img.isReady = false;
        this.img.onload = () => (this.img.isReady = true);
        this.runningHorizontalFrames = 10;
    }

    updateDimensions(canvasWidth, scale = this.scale) {
        this.scale = scale;
    ...
    draw(pointsOuter) {
        ...
        const digit = String(Math.floor(this.points)).padStart(5, '0');
